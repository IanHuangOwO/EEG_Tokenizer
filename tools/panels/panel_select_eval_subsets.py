...
pre-built ctx.dataset. Writes config/finetune_eval_splits/<name>.json.
...
RUN), --se-out-dir (default: that module's 'config/finetune_eval_splits')."""
...
def run(ctx):
    ...
    out_dir = getattr(args, 'se_out_dir', None) or 'config/finetune_eval_splits'

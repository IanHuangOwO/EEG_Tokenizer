...
pre-built ctx.dataset. Writes config/subject_groups/<name>.json.
...
RUN), --se-out-dir (default: that module's 'config/subject_groups')."""
...
def run(ctx):
    ...
    out_dir = getattr(args, 'se_out_dir', None) or 'config/subject_groups'

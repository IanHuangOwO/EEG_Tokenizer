...
`python probes/ft_summary.py output/mesae_finetune_c0_dropout05_5fold/artifacts/train_<timestamp>.log`.
...
`python probes/ft_summary.py output/mesae_finetune_c1_learned2/artifacts/train_<timestamp>.log`.

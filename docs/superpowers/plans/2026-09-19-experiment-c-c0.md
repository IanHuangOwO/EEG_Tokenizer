...
`output/archive/experiment_c/mesae_finetune_c0/artifacts/train_<timestamp>.log`.

- [ ] **Step 4: Read the headline number**

```bash
python probes/ft_summary.py output/archive/experiment_c/mesae_finetune_c0/artifacts/train_<timestamp>.log
```

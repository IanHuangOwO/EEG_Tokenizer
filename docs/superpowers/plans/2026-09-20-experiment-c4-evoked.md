...
- Backbone checkpoint: `output/pretrain/mesae_v10_small/checkpoint/last.pth`.
...
2, checkpoint `mesae_v10_small`). Verify against
`output/archive/experiment_c/mesae_finetune_c1_learned2/artifacts/config.json` (the config C1 actually ran with)
...
`python probes/ft_summary.py output/archive/experiment_c/mesae_finetune_c1_learned2/artifacts/train_20260919_192402.log output/archive/experiment_c/mesae_finetune_c4_evoked/artifacts/train_<timestamp>.log`

...
def build_model(bp, num_channels):
    ...
    return MeSAEPretrain(
        ...
        stamp_amp_log2_range=tuple(sb.get('amp_log2_range', (-14.0, 3.0))),
...
class MeSAETrainer(BaseTrainer):
    ...
    def on_tokenizer_start(self, model, logger=None):
        ...
        together): MeSAE's Tokenizer stage must train StampBank on patch-local,
...
class MeSAEPlotter(BasePlotter):
    def plot_pretrain(self, filename='training_dashboard.png'):
        ...
        routing_panels = [
            ...
            # pool collapse (alive 0.19). See MeSAEPretrain.get_metrics.

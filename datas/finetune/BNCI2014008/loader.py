"""BNCI2014008 (P300 Speller, ALS patients) loader -- see gen_metadata.py
for the format/label notes and docs/agents/adding-a-dataset.md for the
general contract."""
...
class Loader(BaseSubjectLoader):
    ...
    def _load_data(self) -> Tuple[Optional[np.ndarray], Optional[np.ndarray]]:
        ...
        run = d['data']  # single struct, all 7 runs already concatenated -- unlike BNCI2014009
